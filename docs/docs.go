    ...
    "paths": {
        "/api/record/confirm": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Повідомлення про успішне підтвердження запису\"  {\"message\": \"ok\"}",
                        "schema": {
                            "type": "object",
        ...
        "/api/record/create": {
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "Ідентифікатор створеного запису\"  {\"message\": \"ok\", \"record_id\": \"your_record_id_here\"}",
                        "schema": {
                            "type": "object",
                            "additionalProperties": true
                        }
